import { GameInstance, GameStatus, GameType } from '../types';
 ...
 */
const joinGame = async (gameID: string, playerID: string): Promise<GameInstance> => {
 ...
 */
const leaveGame = async (gameID: string, playerID: string): Promise<GameInstance> => {
